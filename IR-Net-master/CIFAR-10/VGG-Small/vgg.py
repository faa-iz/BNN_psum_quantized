...
class split_conv(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True):
        ...
        self.conv1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv4 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv5 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv6 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv7 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv8 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
        self.conv9 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)

        if(in_channels>128):
            self.conv1_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv2_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv3_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv4_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv5_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv6_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv7_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv8_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
            self.conv9_1 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)

            if (in_channels>256):
                self.conv1_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv2_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv3_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv4_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv5_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv6_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv7_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv8_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                self.conv9_2 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)

                if(in_channels>384):
                    self.conv1_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv2_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv3_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv4_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv5_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv6_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv7_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv8_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
                    self.conv9_3 = ir_1w1a.IRConv2d(128, out_channels, kernel_size=1, padding=0, bias=False)#, k = self.k, t=self.t)
    ...
    def forward(self, input):
        ...
        out.append(self.conv1(x1,self.k,self.t))
        out.append(self.conv2(x2,self.k,self.t))
        out.append(self.conv3(x3,self.k,self.t))
        out.append(self.conv4(x4,self.k,self.t))
        out.append(self.conv5(x5,self.k,self.t))
        out.append(self.conv6(x6,self.k,self.t))
        out.append(self.conv7(x7,self.k,self.t))
        out.append(self.conv8(x8,self.k,self.t))
        out.append(self.conv9(x9,self.k,self.t))

        if(self.in_channels>128):
            out.append(self.conv1_1(x12,self.k,self.t))
            out.append(self.conv2_1(x22,self.k,self.t))
            out.append(self.conv3_1(x32,self.k,self.t))
            out.append(self.conv4_1(x42,self.k,self.t))
            out.append(self.conv5_1(x52,self.k,self.t))
            out.append(self.conv6_1(x62,self.k,self.t))
            out.append(self.conv7_1(x72,self.k,self.t))
            out.append(self.conv8_1(x82,self.k,self.t))
            out.append(self.conv9_1(x92,self.k,self.t))

            if (self.in_channels > 256):
                out.append(self.conv1_2(x13,self.k,self.t))
                out.append(self.conv2_2(x23,self.k,self.t))
                out.append(self.conv3_2(x33,self.k,self.t))
                out.append(self.conv4_2(x43,self.k,self.t))
                out.append(self.conv5_2(x53,self.k,self.t))
                out.append(self.conv6_2(x63,self.k,self.t))
                out.append(self.conv7_2(x73,self.k,self.t))
                out.append(self.conv8_2(x83,self.k,self.t))
                out.append(self.conv9_2(x93,self.k,self.t))

                if (self.in_channels > 384):
                    out.append(self.conv1_3(x14,self.k,self.t))
                    out.append(self.conv2_3(x24,self.k,self.t))
                    out.append(self.conv3_3(x34,self.k,self.t))
                    out.append(self.conv4_3(x44,self.k,self.t))
                    out.append(self.conv5_3(x54,self.k,self.t))
                    out.append(self.conv6_3(x64,self.k,self.t))
                    out.append(self.conv7_3(x74,self.k,self.t))
                    out.append(self.conv8_3(x84,self.k,self.t))
                    out.append(self.conv9_3(x94,self.k,self.t))
